...
def create_app(test_config=None ):
    ...
    def get_data():
        ...
        while True:
            ...
            try:
                request = requests.get(f'https://api.polygonscan.com/api?module=account&action=txlist&address=0x65187FeC6eCc4774C1f632C7503466D5B4353Db1&startblock={globals()["block"]}&endblock=lastest&page=1&offset=500&sort=asc&apikey=<yourAPIkey>').json()
